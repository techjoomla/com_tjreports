...
$lang->load('com_tjreports', JPATH_ADMINISTRATOR);
							...
							foreach ($colToshow as $eachColumn)
							{
								...
								if ($sortCol == $eachColumn && !empty($sortCol) && !empty($sortOrder) )
								{
									...
									<th class="th_<?php echo $eachColumn; ?> left <?php echo $class; ?>">
										...
										<?php $calHeading = 'PLG_TJREPORTS_STUDENTCOURSEREPORT_' . $calHeading; ?>

										<a href="#" onclick="sortColumns(this); return false;" class="hasTooltip" title="<?php echo JText::_('PLG_TJREPORTS_STUDENTCOURSEREPORT_SORT'); ?>" data-value="<?php echo $eachColumn; ?>"><?php echo JText::_($calHeading); ?><?php echo $icon; ?></a>
